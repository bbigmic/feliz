  ...
  pl: {
    ...
    orderModal: {
      ...
      codeDescription: 'Dodatkowe informacje o kodzie (opcjonalnie)',
       ...
       collaborationConsent: 'Oświadczam, że opłata zaliczkowa w wysokości 30% ceny oprogramowania dotyczy rozpoczęcia współpracy. Pozostałe 70% jest płatne ratalnie w kolejnych etapach. Skontaktujemy się z Tobą w ciągu 24 godzin w celu ustalenia dalszych kroków i harmonogramu realizacji projektu.',
  ...
  en: {
    ...
    orderModal: {
      ...
      consultationDescription: 'Describe your project, requirements and expectations (optional)',
       ...
       collaborationConsent: 'I declare that the advance payment of 30% of the software price applies to starting collaboration. The remaining 70% is payable in installments in subsequent stages. We will contact you within 24 hours to arrange next steps and project implementation schedule.',
